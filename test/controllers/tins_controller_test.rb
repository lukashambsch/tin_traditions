...
class TinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tin" do
    assert_difference('Tin.count') do
      post tins_url, params: { tin: { purchase_date: @tin.purchase_date, order_number: @tin.order_number, pin: @tin.pin, serial_number: @tin.serial_number } }
    end
  ...
  test "should update tin" do
    patch tin_url(@tin), params: { tin: { purchase_date: @tin.purchase_date, order_number: @tin.order_number, pin: @tin.pin, serial_number: @tin.serial_number } }
